        ...
        <>
            ...
            <div className='relative ml-8 mr-8 -mt-12  grid grid-cols-1 items-center gap-x-6 gap-y-6 rounded-2xl bg-[white] py-8  px-2 shadow-lg sm:grid-cols-2 md:-mt-24 lg:grid-cols-4 xl:-mt-24'>
                <div className='basis-1/4 text-center '>
                    <Image src="/images/Icon1.png" alt='icon' layout='intrinsic' 
                    height={60}
                    width={60}/>
                ...
                <div className='basis-1/4 text-center '>
                    <Image src="/images/Icon2.png" alt='icon' layout='intrinsic' height={60}
                    width={60} />
                ...
                <div className='basis-1/4 text-center '>
                    <Image src="/images/Icon3.png" alt='icon' layout='intrinsic' height={60}
                    width={60}/>
                ...
                <div className='basis-1/4 text-center  '>
                    <Image src="/images/Icon4.png" alt='icon' layout='intrinsic' height={50}
                    width={90} />
