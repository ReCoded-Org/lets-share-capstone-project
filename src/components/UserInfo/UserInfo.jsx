...
const UserInfo = ({ test }) => {
    ...
    const [profile] = useDocument(doc(db, "users", user?.uid));
        ...
        >
            <div className='m-4 flex flex-row items-center justify-center md:flex-col '>
                ...
                <div className=' flex flex-col justify-center md:flex-row '>
                    <button>
                        <MdCameraAlt
                            size={30}
                            className='text-md -translate-x-8 translate-y-8 opacity-60 hover:fill-secondary hover:opacity-100 md:translate-x-8 md:-translate-y-8'
                        />
                    </button>
                </div>
            ...
            <div className='m-4 flex flex-row justify-center rounded-lg bg-[#ffffff] text-sm  md:h-32 md:w-[60%] '>
                ...
                >
                    ...
                    <span className='rounded-full border-2 border-solid border-primary p-2 hover:bg-[#dbdbdb]'>
